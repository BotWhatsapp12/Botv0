...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
        ...
        let zero = fs.readFileSync ('./C/JEMBOTthumb.jpg')
...
switch (command) {
	case 'menu':
	gambar = fs.readFileSync('./C/JEMBOT.jpg')
	timestamp = speed();
...
qute = fs.readFileSync('./C/JEMBOT.jpg') 
...
if (isGroup && budy != undefined) {
	...
	console.log(color('[JEMBOT]', 'red'), 'SEND TO', color(sender.split('@')[0]))
	}		
	} catch (e) {
e = String(e)
